      ...
      <div className="relative z-10">
        ...
        <div className="container mx-auto px-6 py-8">
          ...
          <div className="text-center mb-8">
            <h1 className={`text-3xl md:text-4xl font-bold ${cardiacPattern.textColor} mb-2`}>{cardiacPattern.name}</h1>
            <p className="text-gray-400">{cardiacPattern.description}</p>
          </div>
